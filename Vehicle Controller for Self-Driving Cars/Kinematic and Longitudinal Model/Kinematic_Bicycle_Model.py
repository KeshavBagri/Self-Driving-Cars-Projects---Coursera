...
class Bicycle(Bicycle):
    def step(self, v, w):
        ...
        self.xc= self.xc + (v*math.cos(self.beta+self.theta)*self.sample_time)
        self.yc= self.yc + (v*math.sin(self.beta+self.theta)*self.sample_time)
        self.theta = self.theta + (v*math.cos(self.beta)*math.tan(self.delta)*self.sample_time/self.L)
