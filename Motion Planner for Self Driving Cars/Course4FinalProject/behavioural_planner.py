...
class BehaviouralPlanner:
    ...
    def get_goal_index(self, waypoints, ego_state, closest_len, closest_index):
        ...
        while wp_index < len(waypoints) - 1:
            arc_length += ( (waypoints[wp_index+1][0]-waypoints[wp_index][0])**2 + (waypoints[wp_index+1][1]-waypoints[wp_index][1])**2 )**0.5
            wp_index += 1
            if arc_length > self._lookahead:
                break
        # ------------------------------------------------------------------
    ...
    def check_for_lead_vehicle(self, ego_state, lead_car_position):
        ...
        if not self._follow_lead_vehicle:
            ...
            if lead_car_distance < self._follow_lead_vehicle_lookahead + 10:
                return
...
def get_closest_index(waypoints, ego_state):
    ...
    for i in range(len(waypoints)):
        x = ( (ego_state[0]-waypoints[i][0])**2 + (ego_state[1]-waypoints[i][1])**2 )**0.5
        if closest_len > x:
            closest_len = x
            closest_index = i
    # ------------------------------------------------------------------
